...
Команда разработки:
- :white_check_mark: [Василий Мазаев (в роли Python-разработчика - разработчик 2)](https://github.com/Vasiliy-Mazaev)
- :white_check_mark: [Наталия Погорелова роль (в роли Python-разработчика - разработчик 3)](https://github.com/Natalia-code971)
- :white_check_mark: [Владислав Казаков (в роли Python-разработчика Тимлид - разработчик 1)](https://github.com/vlad-crab)
